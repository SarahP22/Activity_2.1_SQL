...
CREATE DATABASE IF NOT EXISTS `band_db` /*!40100 DEFAULT 
...
INSERT INTO `album` (`idalbum`, `idband`, `albumname`, 
`releasedate`) VALUES
...
(8, 3, 'Tiny Music - Songs from the Vatican Gift Shop', 
'1996-03-05'),
...
(37, 14, ' to Self-Destruct', '2016-11-18'),
...
COLLATE=utf8mb4_0900_ai_ci;
-- Dumping data for table band.instrument: ~0 rows 
-- (approximately)
...
INSERT INTO `player` (`idplayer`, `InstID`, `idband`, `pfname`, 
`plname`, `homecity`, `homestate`) VALUES
...
(19, 3, 9, 'Stefani', 'Germanotta - Lady Gaga', 'New York', 
'NY'),
...
INSERT INTO `venue` (`idvenue`, `vname`, `city`, `state`, 
`zipcode`, `seats`) VALUES
...
(7, 'Capital One Arena', 'Washington', 'DC', '20004', 
20356),
(8, 'SAP Center', 'San Jose', 'CA', '95113', 17562),
(9, 'American Airlines Center', 'Dallas', 'TX', '75209', 
21000),
